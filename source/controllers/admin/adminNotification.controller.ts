// import { Types, startSession } from "prisma";
...
// export async function createSpecificUsersNotification(
//     req: ExpressRequest,
//     res: Response
// ): Promise<Response | void> {
...
//         const notification = await adminNotificationRepository.getOne({
//             _id: notification_id,
//         });
...
//             await adminNotificationRepository.atomicUpdate(
//                 { _id: notification_id },
//                 {
//                     $set: {
...
//             await adminNotificationRepository.findNotificationAdmin(req);
...
//         const update = await adminNotificationRepository.atomicUpdate(
//             { _id: notification_id },
//             {
//                 $set: {
//                     category: category,
...
//         );
//         const notification_id = new Types.ObjectId(req.params.notification_id);
//         const del = await adminNotificationRepository.delete({
//             _id: notification_id,
//         });
...
//     try {
//         const notifications =
//             await adminNotificationRepository.findNotificationNoPagination(req);
//         const fields = [
//             "category",
//             "user_category",
//             "title",
...
// export async function getNotificationsLanding(
//     req: ExpressRequest,
//     res: Response
// ): Promise<Response | void> {
//     try {
//         const userId = throwIfUndefined(req.user, "req.user")._id;
//         const notification =
//             await adminNotificationRepository.getAllNoPagination({
//                 query: userId,
//             });
...
//         const update_count = await userRepository.atomicUpdate(userId, {
...
//         const read_notification = await adminNotificationRepository.batchUpdate(
//             { userId: userId },
//             {
//                 $set: {
//                     status: INotificationStatus.READ,
...
//         const update_count = await userRepository.atomicUpdate(
//             { _id: user._id },
//             {
//                 $set: {
...
//     try {
//         const user = throwIfUndefined(req.user, "req.user");
//         const del = await adminNotificationRepository.batchDelete({
//             userId: user._id,
//         });
